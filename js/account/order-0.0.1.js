...
load_order = function( data, textStatus, xhr ) {
	...
	if (data['order_detail'] == 'error') {
		...
		for (var status in data['order_data']['order_statuses']) {
			var identifier = data['order_data']['order_statuses'][status]['identifier'];
		...
		for (var product_sku in data['order_data']['order_items']['product_sku_data']) {
			...
			var sku_inventory__title = data['order_data']['order_items']['product_sku_data'][product_sku]['sku_inventory__title'];
			var sku_type__title = data['order_data']['order_items']['product_sku_data'][product_sku]['sku_type__title'];
		...
		for (var discount_code in data['order_data']['order_discount_codes']) {
			...
			var discounttype__applies_to = data['order_data']['order_discount_codes'][discount_code]['discounttype__applies_to'];
			var discounttype__description = data['order_data']['order_discount_codes'][discount_code]['discounttype__description'];
			var discounttype__title = data['order_data']['order_discount_codes'][discount_code]['discounttype__title'];
			var end_date_time = data['order_data']['order_discount_codes'][discount_code]['end_date_time'];
			var order_minimum = data['order_data']['order_discount_codes'][discount_code]['order_minimum'];
			var start_date_time = data['order_data']['order_discount_codes'][discount_code]['start_date_time'];
