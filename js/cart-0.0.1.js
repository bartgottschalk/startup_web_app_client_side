...
load_cart_items = function( data, textStatus, xhr ) {
	...
	if (data['cart_found'] == true) {
		...
		for (var product_sku in data['item_data']['product_sku_data']) {
			...
			var sku_type__title = data['item_data']['product_sku_data'][product_sku]['sku_type__title'];
...
load_shipping_methods_details = function(shipping_method_dict, shipping_method_selected) {
	for (var shipping_method in shipping_method_dict) {
		...
		var tracking_code_base_url = shipping_method_dict[shipping_method]['tracking_code_base_url'];
...
load_cart_discount_codes = function( data, textStatus, xhr ) {
	...
	if (data['cart_found'] == true) {
		...
		for (var discount_code in data['discount_code_data']) {
			...
			var discounttype__applies_to = data['discount_code_data'][discount_code]['discounttype__applies_to'];
			var discounttype__description = data['discount_code_data'][discount_code]['discounttype__description'];
			var discounttype__title = data['discount_code_data'][discount_code]['discounttype__title'];
			var end_date_time = data['discount_code_data'][discount_code]['end_date_time'];
			var order_minimum = data['discount_code_data'][discount_code]['order_minimum'];
			var start_date_time = data['discount_code_data'][discount_code]['start_date_time'];
